...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'ecg_balancing.companybalance': {
            ...
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'created_by'", 'null': 'True', 'to': u"orm['auth.User']"}),
            ...
            'updated_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'updated_by'", 'null': 'True', 'to': u"orm['auth.User']"}),
        ...
        u'ecg_balancing.companybalanceindicator': {
            ...
            'relevance_comment': ('django.db.models.fields.TextField', [], {'blank': 'True'})
        },

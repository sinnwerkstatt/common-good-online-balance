...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Indicator.subindicator_number'
        db.add_column(u'ecg_balancing_indicator', 'subindicator_number',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Indicator.subindicator_number'
        db.delete_column(u'ecg_balancing_indicator', 'subindicator_number')

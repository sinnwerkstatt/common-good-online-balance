...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyBalance.company'
        db.add_column(u'ecg_balancing_companybalance', 'company',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name=u'balance', to=orm['ecg_balancing.Company']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompanyBalance.company'
        db.delete_column(u'ecg_balancing_companybalance', 'company_id')

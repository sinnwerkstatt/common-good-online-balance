...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyBalance.status'
        db.add_column(u'ecg_balancing_companybalance', 'status',
                      self.gf('django.db.models.fields.CharField')(default='started', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompanyBalance.status'
        db.delete_column(u'ecg_balancing_companybalance', 'status')

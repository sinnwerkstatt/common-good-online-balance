...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Indicator.parent'
        db.alter_column(u'ecg_balancing_indicator', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['ecg_balancing.Indicator']))

    def backwards(self, orm):

        # Changing field 'Indicator.parent'
        db.alter_column(u'ecg_balancing_indicator', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['ecg_balancing.Indicator']))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Indicator.relevance'
        db.alter_column(u'ecg_balancing_indicator', 'relevance', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

    def backwards(self, orm):

        # Changing field 'Indicator.relevance'
        db.alter_column(u'ecg_balancing_indicator', 'relevance', self.gf('django.db.models.fields.CharField')(default='middle', max_length=10))

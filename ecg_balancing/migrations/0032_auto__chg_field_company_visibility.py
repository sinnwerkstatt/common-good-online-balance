...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Company.visibility'
        db.alter_column(u'ecg_balancing_company', 'visibility', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

    def backwards(self, orm):

        # Changing field 'Company.visibility'
        db.alter_column(u'ecg_balancing_company', 'visibility', self.gf('django.db.models.fields.CharField')(max_length=10))
    ...
    models = {
        ...
        u'ecg_balancing.company': {
            ...
            'visibility': ('django.db.models.fields.CharField', [], {'default': "u'basic'", 'max_length': '10', 'null': 'True', 'blank': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Indicator.contact'
        db.alter_column(u'ecg_balancing_indicator', 'contact', self.gf('ecg_balancing.fields.CommaSeparatedEmailField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Indicator.contact'
        db.alter_column(u'ecg_balancing_indicator', 'contact', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))

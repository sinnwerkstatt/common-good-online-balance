...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyBalanceIndicator.key_figures'
        db.add_column(u'ecg_balancing_companybalanceindicator', 'key_figures',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompanyBalanceIndicator.key_figures'
        db.delete_column(u'ecg_balancing_companybalanceindicator', 'key_figures')

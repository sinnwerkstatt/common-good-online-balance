...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Company.revenue'
        db.delete_column(u'ecg_balancing_company', 'revenue')

        # Deleting field 'Company.profit'
        db.delete_column(u'ecg_balancing_company', 'profit')

        # Adding field 'CompanyBalance.revenue'
        db.add_column(u'ecg_balancing_companybalance', 'revenue',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'CompanyBalance.profit'
        db.add_column(u'ecg_balancing_companybalance', 'profit',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Company.revenue'
        db.add_column(u'ecg_balancing_company', 'revenue',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)
        ...
        # Deleting field 'CompanyBalance.revenue'
        db.delete_column(u'ecg_balancing_companybalance', 'revenue')

        # Deleting field 'CompanyBalance.profit'
        db.delete_column(u'ecg_balancing_companybalance', 'profit')

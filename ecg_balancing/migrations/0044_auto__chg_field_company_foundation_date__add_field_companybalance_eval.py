...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'ecg_balancing_company', 'foundation_date', self.gf('django.db.models.fields.DateField')(null=True))
        # Adding field 'CompanyBalance.evaluation_type'
        db.add_column(u'ecg_balancing_companybalance', 'evaluation_type',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


        # Changing field 'CompanyBalance.end_date'
        db.alter_column(u'ecg_balancing_companybalance', 'end_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'CompanyBalance.start_date'
        db.alter_column(u'ecg_balancing_companybalance', 'start_date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Company.foundation_date'
        db.alter_column(u'ecg_balancing_company', 'foundation_date', self.gf('django.db.models.fields.DateTimeField')(null=True))
        # Deleting field 'CompanyBalance.evaluation_type'
        db.delete_column(u'ecg_balancing_companybalance', 'evaluation_type')


        # Changing field 'CompanyBalance.end_date'
        db.alter_column(u'ecg_balancing_companybalance', 'end_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'CompanyBalance.start_date'
        db.alter_column(u'ecg_balancing_companybalance', 'start_date', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    models = {
        ...
        u'ecg_balancing.companybalance': {
            ...
            'evaluation_type': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

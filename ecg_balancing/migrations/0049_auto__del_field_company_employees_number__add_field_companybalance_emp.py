...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Company.employees_number'
        db.delete_column(u'ecg_balancing_company', 'employees_number')

        # Adding field 'CompanyBalance.employees_number'
        db.add_column(u'ecg_balancing_companybalance', 'employees_number',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Company.employees_number'
        db.add_column(u'ecg_balancing_company', 'employees_number',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=255),
                      keep_default=False)

        # Deleting field 'CompanyBalance.employees_number'
        db.delete_column(u'ecg_balancing_companybalance', 'employees_number')

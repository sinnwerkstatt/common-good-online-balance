...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Indicator.relevance'
        db.add_column(u'ecg_balancing_indicator', 'relevance',
                      self.gf('django.db.models.fields.CharField')(default='middle', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Indicator.relevance'
        db.delete_column(u'ecg_balancing_indicator', 'relevance')

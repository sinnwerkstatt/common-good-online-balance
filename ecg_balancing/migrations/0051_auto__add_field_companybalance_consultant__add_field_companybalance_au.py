...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyBalance.consultant'
        db.add_column(u'ecg_balancing_companybalance', 'consultant',
                      self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompanyBalance.auditor'
        db.add_column(u'ecg_balancing_companybalance', 'auditor',
                      self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompanyBalance.accompanying_consultant'
        db.add_column(u'ecg_balancing_companybalance', 'accompanying_consultant',
                      self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompanyBalance.consultant'
        db.delete_column(u'ecg_balancing_companybalance', 'consultant')

        # Deleting field 'CompanyBalance.auditor'
        db.delete_column(u'ecg_balancing_companybalance', 'auditor')

        # Deleting field 'CompanyBalance.accompanying_consultant'
        db.delete_column(u'ecg_balancing_companybalance', 'accompanying_consultant')
    ...
    models = {
        ...
        u'ecg_balancing.companybalance': {
            ...
            'profit': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'prospect': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'revenue': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),

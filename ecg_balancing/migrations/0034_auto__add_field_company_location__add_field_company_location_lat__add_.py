...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'ecg_balancing_company', 'location',
                      self.gf('osm_field.fields.OSMField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Company.location_lat'
        db.add_column(u'ecg_balancing_company', u'location_lat',
                      self.gf('osm_field.fields.LatitudeField')(default=1.1),
                      keep_default=False)

        # Adding field 'Company.location_lon'
        db.add_column(u'ecg_balancing_company', u'location_lon',
                      self.gf('osm_field.fields.LongitudeField')(default=1.1),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Company.location_lat'
        db.delete_column(u'ecg_balancing_company', u'location_lat')

        # Deleting field 'Company.location_lon'
        db.delete_column(u'ecg_balancing_company', u'location_lon')

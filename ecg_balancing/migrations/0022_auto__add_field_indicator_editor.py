...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Indicator.editor'
        db.add_column(u'ecg_balancing_indicator', 'editor',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Indicator.editor'
        db.delete_column(u'ecg_balancing_indicator', 'editor')

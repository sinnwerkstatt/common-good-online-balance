...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Indicator.subindicator_number'
        db.alter_column(u'ecg_balancing_indicator', 'subindicator_number', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Indicator.subindicator_number'
        db.alter_column(u'ecg_balancing_indicator', 'subindicator_number', self.gf('django.db.models.fields.IntegerField')(default=0))

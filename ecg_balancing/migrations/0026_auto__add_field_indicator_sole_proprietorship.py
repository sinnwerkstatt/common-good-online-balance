...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Indicator.sole_proprietorship'
        db.add_column(u'ecg_balancing_indicator', 'sole_proprietorship',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Indicator.sole_proprietorship'
        db.delete_column(u'ecg_balancing_indicator', 'sole_proprietorship')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CompanyBalance.year'
        db.alter_column(u'ecg_balancing_companybalance', 'year', self.gf('django.db.models.fields.SmallIntegerField')(default=2014, max_length=4))

    def backwards(self, orm):

        # Changing field 'CompanyBalance.year'
        db.alter_column(u'ecg_balancing_companybalance', 'year', self.gf('django.db.models.fields.SmallIntegerField')(max_length=4, null=True))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CompanyBalance.public'
        db.delete_column(u'ecg_balancing_companybalance', 'public')

        # Adding field 'CompanyBalance.visibility'
        db.add_column(u'ecg_balancing_companybalance', 'visibility',
                      self.gf('django.db.models.fields.CharField')(default=u'internal', max_length=15),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CompanyBalance.public'
        db.add_column(u'ecg_balancing_companybalance', 'public',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'CompanyBalance.visibility'
        db.delete_column(u'ecg_balancing_companybalance', 'visibility')

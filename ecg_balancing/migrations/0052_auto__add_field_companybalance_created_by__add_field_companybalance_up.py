...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'ecg_balancing_companybalance', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name=u'created_by', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'CompanyBalance.updated_by'
        db.add_column(u'ecg_balancing_companybalance', 'updated_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name=u'updated_by', to=orm['auth.User']),
                      keep_default=False)
    ...
    models = {
        ...
        u'ecg_balancing.companybalance': {
            ...
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'related_name': "u'created_by'", 'to': u"orm['auth.User']"}),
            ...
            'updated_by': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'related_name': "u'updated_by'", 'to': u"orm['auth.User']"}),

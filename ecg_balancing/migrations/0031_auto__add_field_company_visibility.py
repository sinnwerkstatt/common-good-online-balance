...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Company.visibility'
        db.add_column(u'ecg_balancing_company', 'visibility',
                      self.gf('django.db.models.fields.CharField')(default=u'basic', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Company.visibility'
        db.delete_column(u'ecg_balancing_company', 'visibility')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyBalance.internal_communication'
        db.add_column(u'ecg_balancing_companybalance', 'internal_communication',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompanyBalance.internal_communication'
        db.delete_column(u'ecg_balancing_companybalance', 'internal_communication')

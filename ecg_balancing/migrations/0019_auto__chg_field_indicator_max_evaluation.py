...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Indicator.max_evaluation'
        db.alter_column(u'ecg_balancing_indicator', 'max_evaluation', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Indicator.max_evaluation'
        db.alter_column(u'ecg_balancing_indicator', 'max_evaluation', self.gf('django.db.models.fields.IntegerField')(default=0))

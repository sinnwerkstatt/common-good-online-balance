...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyBalance.points'
        db.add_column(u'ecg_balancing_companybalance', 'points',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0, max_length=4),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompanyBalance.points'
        db.delete_column(u'ecg_balancing_companybalance', 'points')

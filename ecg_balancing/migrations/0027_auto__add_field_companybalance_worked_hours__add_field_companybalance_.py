...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyBalance.worked_hours'
        db.add_column(u'ecg_balancing_companybalance', 'worked_hours',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompanyBalance.number_participated_employees'
        db.add_column(u'ecg_balancing_companybalance', 'number_participated_employees',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompanyBalance.worked_hours'
        db.delete_column(u'ecg_balancing_companybalance', 'worked_hours')

        # Deleting field 'CompanyBalance.number_participated_employees'
        db.delete_column(u'ecg_balancing_companybalance', 'number_participated_employees')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Company.employees_number'
        db.alter_column(u'ecg_balancing_company', 'employees_number', self.gf('django.db.models.fields.CharField')(default='small', max_length=255))

    def backwards(self, orm):

        # Changing field 'Company.employees_number'
        db.alter_column(u'ecg_balancing_company', 'employees_number', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

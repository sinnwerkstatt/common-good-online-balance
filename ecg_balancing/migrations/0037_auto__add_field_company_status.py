...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'ecg_balancing_company', 'status',
                      self.gf('django.db.models.fields.CharField')(default=u'not-approved', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Company.status'
        db.delete_column(u'ecg_balancing_company', 'status')

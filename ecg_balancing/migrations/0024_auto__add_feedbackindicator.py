...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FeedbackIndicator'
        db.create_table(u'ecg_balancing_feedbackindicator', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('indicator', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'feedback', to=orm['ecg_balancing.Indicator'])),
            ...
            ('receiver_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('receiver_email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True)),
            ('message', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'ecg_balancing', ['FeedbackIndicator'])


    def backwards(self, orm):
        # Deleting model 'FeedbackIndicator'
        db.delete_table(u'ecg_balancing_feedbackindicator')

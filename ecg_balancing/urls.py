...
urlpatterns = patterns('',
	...
	url(r'^balance/create$', login_required(CompanyBalanceCreateView.as_view()), name='create-company'),
	url(r'^balance/(?P<pk>.*?)/update$', login_required(CompanyBalanceUpdateView.as_view()), name='update-company'),
	url(r'^balance/(?P<pk>.*?)$', login_required(CompanyBalanceDetailView.as_view()), name='company-balance'),
